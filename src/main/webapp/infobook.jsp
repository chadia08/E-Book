...
<%
    ...
    {
    	response.sendRedirect("http://localhost:8080/library/login.jsp");	
    }
    else{ String nom =(String) sess.getAttribute("nom");     } %>
        ...
        <!------------------------------------------- Begin Page Content -------------------------------------------->
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                     ...
                     <!------- Card Start ------------------------------------------------------>
			        <div class="card m-4" style="max-height: 100%;">
			          <div class="row ">
			      		<div class="col-md-6">
			    		<img src="${book.image}" class="m-4 card-img">
			            </div>
			            <div class="col-md-6">
			            	<div class="card-block p-4">
	                            <h1 style='font-size: 2rem;font-weight:bold;'><c:out value='${book.titre}' /></h1>
	                            <h5 class='text'><i><c:out value='Categorie: ${book.categorie}' /></i></h5>
	                            <h5 class='text-gray' ><i><c:out value='Auteur: ${book.auteur}' /></i></h5>
	                            <p style='font-size: 1rem;'><c:out value='${book.description}' /> </p>
							    <div class="me-3">
	                            	<button type="button mt-3" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalemprunt">Buy now</button>
							   		&nbsp;&nbsp;&nbsp;<b style="color:black; font-size:30px; "><c:out value='${book.prix}$'/></b>
							   	</div>
			             	</div>
			           	</div>
			          </div>
...
<!-- Modal form  -->
		<form method="POST" action='insertachat'>
			<div class="modal fade" id="exampleModalemprunt" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			  <div class="modal-dialog modal-md">
			    <div class="modal-content">
			      <div class="modal-header">
			        <h5 class="modal-title">Formulaire d'achat :</h5>
			        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			      </div>
			      <div class="modal-body">
			        <div  class="row g-3" >
			  <div class="col-md-3">
			    <label for="validationDefault01" class="form-label">Id_livre</label>
			    <input type="text" class="form-control" id="validationDefault01" name="id_livre" value='<c:out value='${book.id_livre}' />'   readonly>
			  </div>
			  <div class="col-md-5">
			  ...
			  <div class="col-md-5">
			   ...
			   <div class="col-md-5">
			    ...
			    <input type="text" class="form-control" id="prix" value='<c:out value='${book.prix}' />' readonly>
			  </div>
			  <div class="col-md-5">
			    <label for="carte" class="form-label">N° de carte</label>
			    <input type="text" class="form-control" id="carte" >
			  </div>
			  <div class="col-md-5">
			  ...
			  <div class="col-md-5">
			    ...
			    <input type="text" class="form-control" id="cvv" >
			      ...
			      <div class="modal-footer mt-4">
			        ...
			        <a  type="submit" class="btn btn-primary" href="livre.txt" download='<c:out value='${book.id_livre}.pdf'/>'>Confirmer</a>
			      </div>
			    </div>
			  </div>
			</div>
