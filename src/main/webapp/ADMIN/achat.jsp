        ...
        <!------------------------------------------- Begin Page Content -------------------------------------------->
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">List Of Purchases</h1>
                    </div>
                    <br>
          ...
          <tbody>
            <c:forEach var="achat" items="${res.rows}">
						...
						<tr>
							<td><c:out value="${achat.id_achat}" /></td>
							<td><c:out value="${achat.date}" /></td>
							<td><c:out value="${achat.id_livre}" /></td>
							<td><c:out value="${achat.id}" /></td>	
				            <td>
				              <a href="deleteachat?id=<c:out value='${achat.id_achat}' />&id_livre=<c:out value="${achat.id_livre}" />" class="text-danger me-3 ms-3"> <i class="fas fa-trash"> </i> </a>
				            </td>
				        </tr>
            </c:forEach> 
          </tbody>
