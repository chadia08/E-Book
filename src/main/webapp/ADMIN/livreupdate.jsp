...
<sql:setDataSource var="db" driver="com.mysql.jdbc.Driver"  url="jdbc:mysql://localhost:3306/ebook"  user="root"  password=""/>
  ...
  <div class="row">
     ...
     <main class="col-md-9 ms-sm-auto col-lg-11 px-md-4 p-4">
		...
		<form action="updatebook" method="post" accept-charset="utf-8" >
        	<div  class="row g-3" >
  				<div class="col-md-2">
    				...
    				<input type="text" class="form-control " id="validationDefault01" value="<c:out value='${book.id_livre}' />"   name='id_livre'  lang='fr' readonly>
  				</div>
  				<div class="col-md-4">
			 	...
			 	<div class="col-md-4">
  				...
  				<div class="col-md-3">
				    ...
				    <input type="number" class="form-control" id="validationDefault05"  value="<c:out value='${book.nbpages}' />"  lang='fr'  name='nbpages' >
  				</div>  
				<div class="col-md-12">
				    <label for="exampleFormControlTextarea1">Description</label>
				    <textarea class="form-control" id="exampleFormControlTextarea1" lang='fr' accept-charset="utf-8" name='description' rows="2"><c:out value='${book.description}' /></textarea>
				</div>
				<div class="col-md-4">
				    <label for="validationDefault08" class="form-label">Url image</label>
				    <input type="text" class="form-control" id="validationDefault08"  value="<c:out value='${book.image}' />"   name='image' lang='fr' required>
  				</div>
				<div class="col-md-3">
				    <label for="validationDefault09" class="form-label">Prix</label>
				    <input type="number" class="form-control" id="validationDefault09"  value="<c:out value='${book.prix}' />"  lang='fr'  name='prix' >
  				</div>  
		</div>
