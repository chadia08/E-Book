...
<sql:setDataSource var="db" driver="com.mysql.jdbc.Driver"  url="jdbc:mysql://localhost/ebook"  user="root"  password=""/>
    ...
    <div id="wrapper">
        ...
        <!------------------------------------------- Begin Page Content -------------------------------------------->
          ...
          <tbody>
            <c:forEach var="users" items="${rs.rows}">

						<tr>
							<td><c:out value="${users.id}" /></td>
							<td><c:out value="${users.nom}" /></td>
							<td><c:out value="${users.prenom}" /></td>
							<td><c:out value="${users.email}" /></td>	
				            <td>
				              <a href="deleteuser?id=<c:out value='${users.id_user}' />&id_user=<c:out value="${users.id}" />" class="text-danger me-3 ms-3"> <i class="fas fa-trash"> </i> </a>
				            </td>
				        </tr>
            </c:forEach> 
          </tbody>
